...
public class WeaponTest {
    ...
    void fight03() {
        Warrior unit1 = HEALER.make();
        Warrior unit2 = KNIGHT.make();
        Weapon weapon1 = MAGIC_WAND.make();
        Weapon weapon2 = KATANA.make();
        unit1.equipWeapon(weapon1);
        unit2.equipWeapon(weapon2);
